# Frontend Mentor: página de inicio de Huddle con una sola sección introductoria

![Vista previa del diseño de la página de inicio de Huddle con una sola sección introductoria](./design/desktop-preview.jpg)
...
Su desafío es construir esta página de destino a partir de los diseños provistos en el código de inicio.
...
2. Tuitee [@frontendmentor](https://twitter.com/frontendmentor) y mencione **@frontendmentor**, incluido el repositorio y las URL en vivo en el tweet. Nos encantaría echar un vistazo a lo que ha creado y ayudar a compartirlo.
